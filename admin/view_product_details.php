...
<div class="container-fluid my-5">
    <div class="d-flex mt-4 justify-content-between flex-wrap flex-md-nowrap align-items-cpy-4">
        <h2 class="h4">
            <?php echo ucwords(strtolower($result[0]['name'])); ?> Details
        </h2>
    </div>
        ...
        <div class="main_form_div p-0">
                ...
                foreach ($result as $key => $row) {
                    ...
                    <div class="col-lg-2 col-md-2 col-sm-3 col-6 main_form_col">
                        <div class="form-group my-4">
                            <div class="view_product_pic" style="aspect-ratio: 4/3;">
            ...
            <div class="form-group mb-4">
                ...
                <div class="form-control">
                    <?php echo ucwords(strtolower($result[0]['category_name'])); ?>
                </div>
            </div>
            ...
            <div class="form-group mb-4">
                ...
                <div class="form-control">
                    <?php echo ucwords(strtolower($result[0]['name'])); ?>
                </div>
            </div>
            ...
            <div class="form-group mb-4">
                ...
                <div class="form-control">
                    <?php echo ucwords(strtolower($result[0]['description'])); ?>
                </div>
            </div>
            ...
            <div class="form-group mb-4">
                ...
                <div class="form-control">
                    <?php echo ucwords(strtolower($result[0]['stock'])); ?>
                </div>
            </div>
            ...
            <div class="form-group mb-4">
                ...
                <div class="form-control">
                    <?php echo ucwords(strtolower($result[0]['quantity'])); ?>
                </div>
            </div>
            ...
            <div class="form-group mb-4">
                ...
                <div class="form-control">
                    <?php echo ucwords(strtolower($result[0]['quantity_unit'])); ?>
                </div>
            </div>
            ...
            <div class="form-group mb-4">
                ...
                <div class="form-control">
                    <?php echo ucwords(strtolower($result[0]['original_price'])); ?>
                </div>
            </div>
            ...
            <div class="form-group mb-4">
                ...
                <div class="form-control">
                    <?php echo ucwords(strtolower($result[0]['selling_price'])); ?>
                </div>
            </div>
        </div>
    </div>
