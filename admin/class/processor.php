...
if($method=="POST")
{
	...
	// add products
	if(isset($_POST['add_products']) && isset($_POST['category_name']) && isset($_POST['subcategory_name']))
	{
		$product_image = $_FILES['product_image']['name'];
		$tmp_product_image = $_FILES['product_image']['tmp_name'];

		$category_name = base64_decode($_POST['category_name']);
		$subcategory_name = base64_decode($_POST['subcategory_name']);
	...
	// update products
	if(isset($_POST['update_products']) && isset($_POST['category_name']) && isset($_POST['subcategory_name']))
	{
