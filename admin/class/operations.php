...
class operations extends database
{
	...
	public function add_products($product_image, $tmp_product_image, $category_name, $subcategory_name, $product_name, $product_details, $stock_quantity, $product_quantity, $quantity_unit, $original_price, $discount_price)
	{
		...
		$sql = "INSERT INTO `products`(`category`, `subcategory`, `name`, `details`, `stock`, `quantity`, `quantity_unit`, `original_price`, `selling_price`) VALUES ('$this->category_name', '$this->subcategory_name', '$this->product_name', '$this->product_details', '$this->stock_quantity', '$this->product_quantity', '$this->quantity_unit', '$this->original_price', '$this->discount_price')";
		...
		if(parent::sql($sql))
		{
			...
			$get_id_sql = "SELECT * FROM products WHERE `category` = '$this->category_name' AND `subcategory` = '$this->subcategory_name' AND `name` = '$this->product_name' AND `details` = '$this->product_details' AND `original_price` = '$this->original_price'";
	...
	public function update_products($product_id, $product_image, $tmp_product_image, $category_name, $subcategory_name, $product_name, $product_details, $stock_quantity, $product_quantity, $quantity_unit, $original_price, $discount_price)
	{
		...
		$sql = "UPDATE `products` SET `category` = '$this->category_name', `subcategory` = '$this->subcategory_name', `name` = '$this->product_name', `details` = '$this->product_details', `stock` = '$this->stock_quantity', `quantity` = '$this->product_quantity', `quantity_unit` = '$this->quantity_unit', `original_price` = '$this->original_price', `selling_price` = '$this->discount_price' WHERE id = '$this->id'";
