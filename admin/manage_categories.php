        ...
        <div class="main_form_div p-0">
            <form id="add_category_module" enctype="multipart/form-data">
                        ...
                        <div class="form-group my-4">
                            <div id="profile_pic">
                                <div class="profile_pic_edit">
                                    <input required="required" type='file' name="category_icon" id="profile_upload"
                                        accept=".png, .jpg, .jpeg" class="form-control">
                                    <label for="profile_upload" id="profile_pic_btn"></label>
                                </div>
                                <div class="profile_pic_preview">
                                    <div class="category_icon" id="profile_pic_preview"
                ...
                <div class="form-group mb-4">
                    ...
                    <input required="required" type="text" class="form-control" id="category_name" name="category_name"
                        placeholder="Enter Category Name">
                </div>

                <div class="form-group mb-4">
                    <p for="category_bg_color"><strong>Select Category Color</strong></p>
                    <input required="required" type="text" class="form-control" id="category_bg_color" data-coloris
                        name="category_bg_color" value="#00ff80" placeholder="Select Color">
                </div>
                ...
                <tr>
                    <td>
                        <a href="javascript:void(0);" class="font-weight-bold">
                            CATE000<?php echo $data['id']; ?>
                        </a>
                    </td>
                    <td>
                        <img class="img-fluid category_img_listed"
                            src="<?php echo !empty($data['icon']) ? '../src/images/categories/thumbnails/' . $data['icon'] : "./assets/images/placeholder.png"; ?>" />
                    </td>
                    <td>
                    ...
                    <td>
                        <span
                            class="font-weight-normal wrap_text_data d-flex justify-content-center align-items-center">
                            <?php echo !empty($data['color']) ? '<span class="category_color" style="height:40px; width:80px; border-radius:5px; display:block; background:' . $data['color'] . ';"></span>' : "No Color Available"; ?>
                        </span>
                    </td>
                    <td>
                        <span class="font-weight-normal wrap_text_data">
                    ...
                    <td>
                        <div class="btn-group">
                            ...
                            <div class="dropdown-menu">
                                <a class="dropdown-item text-dark edit_category_btn"
                                    href="edit_categories?data=<?php echo base64_encode($data['name']) . '&id=' . base64_encode($data['id']); ?>"><span
                                        class="fas fa-edit mr-2"></span>Edit</a>
                                <a class="dropdown-item text-danger delete_category_btn" href="javascript:void(0);"
                                    categories-id="<?php echo base64_encode($data['id']); ?>"><span
