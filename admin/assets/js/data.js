	...
	if (confirm("Are You Sure You Want to Remove Product From Trending ?")) {
		$.ajax({
			...
			success: function (result) {
				...
				if (message == "failed") {
					var noti =
						"<div class='boot_notify_data alert alert-danger alert-dismissible fade show' role='alert'>Failed To Remove Please Try Again Later !<button type='button' class='btn-close' data-dismiss='alert' aria-label='Close'></button></div>";
					$("body").append(noti);
					$(".boot_notify_data").fadeOut(8000);
				}
				if (message == "success") {
					var noti =
						"<div class='boot_notify_data alert alert-success alert-dismissible fade show' role='alert'>Removed Successfully !<button type='button' class='btn-close' data-dismiss='alert' aria-label='Close'></button></div>";
					$("body").append(noti);
					$(".boot_notify_data").fadeOut(5000);
					location.reload();
				}
...
$("#add_delivery_pincode_module").on("submit", function (e) {
	...
	$.ajax({
		...
		success: function (result) {
			...
			if (message == "failed") {
				var noti =
					"<div class='boot_notify_data alert alert-danger alert-dismissible fade show' role='alert'>Failed To Add Pincode Please Try Again Later !<button type='button' class='btn-close' data-dismiss='alert' aria-label='Close'></button></div>";
				$("body").append(noti);
				$(".boot_notify_data").fadeOut(8000);
			}
			...
			if (message == "exist") {
				var noti =
					"<div class='boot_notify_data alert alert-warning alert-dismissible fade show' role='alert'>Pincode Already Exist !<button type='button' class='btn-close' data-dismiss='alert' aria-label='Close'></button></div>";
				$("body").append(noti);
				$(".boot_notify_data").fadeOut(8000);
			}
			...
			if (message == "success") {
				var noti =
					"<div class='boot_notify_data alert alert-success alert-dismissible fade show' role='alert'>Pincode Added Successfully !<button type='button' class='btn-close' data-dismiss='alert' aria-label='Close'></button></div>";
				$("body").append(noti);
				$(".boot_notify_data").fadeOut(5000);
				location.reload();
			}
...
$(document).on("click", ".contacted_enquiry_message", function () {
	...
	if (
		confirm(
			"This Can't Be Undone Are You Sure You Want to Mark This Enquiry as Contacted ?"
		)
	) {
		$.ajax({
			url: "././class/processor.php",
			type: "POST",
			data:
				"mark_enquiry_as_contacted_data=true&enquiry_id=" + enquiry_id,
			cache: false,
			processData: false,
			success: function (result) {
				var message = result;
				if (
					message ==
					"Failed To Mark as Contacted Please Try Again Later !"
				) {
					var noti =
						"<div class='boot_notify_data alert alert-danger alert-dismissible fade show' role='alert'>Failed To Mark as Contacted Please Try Again Later !<button type='button' class='btn-close' data-dismiss='alert' aria-label='Close'></button></div>";
					$("body").append(noti);
					$(".boot_notify_data").fadeOut(8000);
				}
				if (message == "Marked as Contacted Successfully !") {
					var noti =
						"<div class='boot_notify_data alert alert-success alert-dismissible fade show' role='alert'>Marked as Contacted Successfully !<button type='button' class='btn-close' data-dismiss='alert' aria-label='Close'></button></div>";
					$("body").append(noti);
					$(".boot_notify_data").fadeOut(5000);
					location.reload();
				}
...
$(document).on("click", "#assign_captain_main_btn", function () {
	...
	if (captain != "" && captain != undefined && captain != null) {
		if (
			confirm(
				"Are you sure you want to assign captain to this order ? This can't be undone."
			)
		) {
			$.ajax({
				url: "././class/processor.php",
				type: "POST",
				data:
					"assign_order_to_captain=true&order_id=" +
					order_id +
					"&captain=" +
					captain +
					"&customer=" +
				...
				beforeSend: function () {
					$(".submit_btn").hide();
					$(".btn_group_div_main").append(
						'<button class="status_loader_status btn btn-info" type="button" disabled><span class="spinner-border spinner-border-sm" role="status" aria-hidden="true"></span>Please Wait...</button>'
					);
				},
				complete: function () {
					$(".submit_btn").show();
				...
				success: function (result) {
					...
					if (message == "failed") {
						var noti =
							"<div class='boot_notify_data alert alert-danger alert-dismissible fade show' role='alert'>Failed To Assign Order to Captain, Please Try Again Later !<button type='button' class='btn-close' data-dismiss='alert' aria-label='Close'></button></div>";
						$("body").append(noti);
						$(".boot_notify_data").fadeOut(8000);
					}
					if (message == "success") {
						var noti =
							"<div class='boot_notify_data alert alert-success alert-dismissible fade show' role='alert'>Order Assigned to Captain Successfully !<button type='button' class='btn-close' data-dismiss='alert' aria-label='Close'></button></div>";
						$("body").append(noti);
						$(".boot_notify_data").fadeOut(5000);
						location.reload();
					}
		...
		var noti =
			"<div class='boot_notify_data alert alert-danger alert-dismissible fade show' role='alert'>Please Select the Captain First to Assign Order !<button type='button' class='btn-close' data-dismiss='alert' aria-label='Close'></button></div>";
		$("body").append(noti);
		$(".boot_notify_data").fadeOut(8000);
	}
});
...
$("#add_delivery_boy_module").on("submit", function (e) {
	...
	$.ajax({
		...
		success: function (result) {
			...
			if (message == "failed") {
				var noti =
					"<div class='boot_notify_data alert alert-danger alert-dismissible fade show' role='alert'>Failed To Add Captain Please Try Again Later !<button type='button' class='btn-close' data-dismiss='alert' aria-label='Close'></button></div>";
				$("body").append(noti);
				$(".boot_notify_data").fadeOut(8000);
			}
			...
			if (message == "exist") {
				var noti =
					"<div class='boot_notify_data alert alert-danger alert-dismissible fade show' role='alert'>Captain Already Exist !<button type='button' class='btn-close' data-dismiss='alert' aria-label='Close'></button></div>";
				$("body").append(noti);
				$(".boot_notify_data").fadeOut(8000);
			}
			...
			if (message == "success") {
				var noti =
					"<div class='boot_notify_data alert alert-success alert-dismissible fade show' role='alert'>Captain Added Successfully !<button type='button' class='btn-close' data-dismiss='alert' aria-label='Close'></button></div>";
				$("body").append(noti);
				$(".boot_notify_data").fadeOut(5000);
				location.reload();
			}
...
$("#update_delivery_boy_module").on("submit", function (e) {
	...
	$.ajax({
		...
		success: function (result) {
			...
			if (message == "failed") {
				var noti =
					"<div class='boot_notify_data alert alert-danger alert-dismissible fade show' role='alert'>Failed To Update Captain Please Try Again Later !<button type='button' class='btn-close' data-dismiss='alert' aria-label='Close'></button></div>";
				$("body").append(noti);
				$(".boot_notify_data").fadeOut(8000);
			}
			...
			if (message == "success") {
				var noti =
					"<div class='boot_notify_data alert alert-success alert-dismissible fade show' role='alert'>Captain Updated Successfully !<button type='button' class='btn-close' data-dismiss='alert' aria-label='Close'></button></div>";
				$("body").append(noti);
				$(".boot_notify_data").fadeOut(5000);
				location.reload();
			}
...
$(document).on("click", ".pay_delivery_boy_income", function () {
	...
	if (
		confirm(
			"This Can't Be Undone Are You Sure You Want to Mark Payment as Paid ?"
		)
	) {
		$.ajax({
			url: "././class/processor.php",
			type: "POST",
			data:
				"pay_delivery_boy_income=true&captain=" +
				captain +
				"&month=" +
				month +
				"&total_delivery=" +
			...
			success: function (result) {
				...
				if (message == "failed") {
					var noti =
						"<div class='boot_notify_data alert alert-danger alert-dismissible fade show' role='alert'>Failed to Pay Captain !<button type='button' class='btn-close' data-dismiss='alert' aria-label='Close'></button></div>";
					$("body").append(noti);
					$(".boot_notify_data").fadeOut(8000);
				}
				if (message == "success") {
					var noti =
						"<div class='boot_notify_data alert alert-success alert-dismissible fade show' role='alert'>Captain Payment Done Successfully !<button type='button' class='btn-close' data-dismiss='alert' aria-label='Close'></button></div>";
					$("body").append(noti);
					$(".boot_notify_data").fadeOut(5000);
					location.reload();
				}
...
$("#update_payment_method").on("submit", function (e) {
	...
	$.ajax({
		...
		success: function (result) {
			...
			if (
				message ==
				"Failed To Update Payment Methods Please Try Again Later !"
			) {
				var noti =
					"<div class='boot_notify_data alert alert-danger alert-dismissible fade show' role='alert'>Failed To Update Payment Methods Please Try Again Later !<button type='button' class='btn-close' data-dismiss='alert' aria-label='Close'></button></div>";
				$("body").append(noti);
				$(".boot_notify_data").fadeOut(8000);
			}
			if (message == "Payment Methods Updated Successfully !") {
				var noti =
					"<div class='boot_notify_data alert alert-success alert-dismissible fade show' role='alert'>Payment Methods Updated Successfully !<button type='button' class='btn-close' data-dismiss='alert' aria-label='Close'></button></div>";
				$("body").append(noti);
				$(".boot_notify_data").fadeOut(5000);
				location.reload();
			}
...
$("#update_app_version").on("submit", function (e) {
	...
	$.ajax({
		...
		success: function (result) {
			...
			if (message == "failed") {
				var noti =
					"<div class='boot_notify_data alert alert-danger alert-dismissible fade show' role='alert'>Failed To Update Application Version Please Try Again Later !<button type='button' class='btn-close' data-dismiss='alert' aria-label='Close'></button></div>";
				$("body").append(noti);
				$(".boot_notify_data").fadeOut(8000);
			}
			if (message == "success") {
				var noti =
					"<div class='boot_notify_data alert alert-success alert-dismissible fade show' role='alert'>Application Version Updated Successfully !<button type='button' class='btn-close' data-dismiss='alert' aria-label='Close'></button></div>";
				$("body").append(noti);
				$(".boot_notify_data").fadeOut(5000);
				location.reload();
			}
...
$("#update_store_status").on("submit", function (e) {
	...
	$.ajax({
		...
		success: function (result) {
			...
			if (message == "failed") {
				var noti =
					"<div class='boot_notify_data alert alert-danger alert-dismissible fade show' role='alert'>Failed To Update Store Status Please Try Again Later !<button type='button' class='btn-close' data-dismiss='alert' aria-label='Close'></button></div>";
				$("body").append(noti);
				$(".boot_notify_data").fadeOut(8000);
			}
			if (message == "success") {
				var noti =
					"<div class='boot_notify_data alert alert-success alert-dismissible fade show' role='alert'>Store Status Updated Successfully !<button type='button' class='btn-close' data-dismiss='alert' aria-label='Close'></button></div>";
				$("body").append(noti);
				$(".boot_notify_data").fadeOut(5000);
				location.reload();
			}
