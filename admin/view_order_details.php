...
if($db->sql($sql))
{
    $numrows = $db->numrows();
    $result = $db->result()[0];
    $billing_details = json_decode($result['booking_address'], true);
...
<div class="container-fluid my-5 order_details_container_main">
    ...
    <div class="d-flex mt-4 justify-content-between flex-wrap flex-md-nowrap align-items-center py-4">
        <div class="d-block mb-4 mb-md-0">
            <h2 class="h4"><?php echo $billing_details['name']; ?></h2>
            <p class="mb-0"><?php echo $billing_details['address']; ?></p>
        </div>
    ...
    <div class="card card-body border-light shadow-sm table-wrapper table-responsive py-4">
        <table class="table table-hover table-bordered table-responsive">
            <tbody>
                <tr>
                    <th>#ID</th>
                    <td>ORDR<?php echo 9999 + $result['id']; ?></td>
                </tr>
                <tr>
                    <th>Booking ID</th>
                ...
                <tr>
                    <th>Order Date</th>
                    <td><?php echo date("d M Y h:i:s a", strtotime($result['date_time'])); ?></td>
                </tr>
                <tr>
                    <th>Name</th>
                    <td><?php echo $billing_details['name']; ?></td>
                </tr>
                <tr>
                    <th>Phone No</th>
                    <td><?php echo $billing_details['phone']; ?></td>
                </tr>
                <tr>
                    <th>Products</th>
                    <td>
                ...
                <tr>
                    ...
                    <td><?php echo $billing_details['address']; ?></td>
                </tr>
                <tr>
                    <th>Amount</th>
                    <td>₹<?php echo $result['cart_amount']; ?></td>
                </tr>
                <tr>
                    <th>Discount</th>
                    <td>₹<?php echo $result['cart_amount'] - $result['discount_amt']; ?></td>
                </tr>
                <tr>
                    <th>Delivery Charges</th>
                    <td>₹<?php echo $result['delivery_charges'] == 0 ? "Free" : $result['delivery_charges']; ?></td>
                </tr>
                <tr>
                    <th>Coupon Used</th>
                    <td><?php echo !empty($result['coupon_code']) ? $result['coupon_code'] : "No Coupon Code Used"; ?></td>
                </tr>
                <tr>
                    <th>Coupon Discount</th>
                    <td>₹<?php echo !empty($result['coupon_discount']) ? $result['coupon_discount'] : 0; ?></td>
                </tr>
                <tr>
                    <th>Final Amount</th>
                ...
                <tr>
                    <th>Payment Mode</th>
                    <td><?php echo $result['payment_method'] == "COD" ? "Cash On Delivery" : "Online"; ?></td>
                </tr>
                <tr>
                    <th>Payment ID</th>
                    <td><?php echo !empty($result['payment_id']) ? $result['payment_id'] : "Not Applicable"; ?></td>
                </tr>
                <tr>
                    <th>Order Status</th>
                    <td class="font-weight-bold"><?php echo $result['order_status']; ?></td>
                </tr>
                <tr>
                    <th>Action</th>
                    <td>
                        <div class="btns_action d-flex">
                            ...
                            <div class="input-group mr-3 w-75 btn_group_div_main">
                                <select class="form-select order_status_dropdown">
                                    ...
                                    {
                                    ?>
                                    <option value="Out" <?php echo $result['order_status'] == "Out" ? "selected" : ''; ?>>Out For Delivery</option>
                                    <?php
                                    }
                                ...
                                <button data-id="<?php echo base64_encode($result['id']); ?>" class="btn btn-tertiary submit_btn" type="button" id="update_order_status">Update</button>
                            </div>
                            <?php
                            }
                            ?>
                            ...
                            if($db->sql($check_del))
                            {
                                ...
                                <div class="assign_delivery_boy_module_div mt-3">
                                    ...
                                    <div class="input-group btn_group_div_main">
                                        <span title="Enter Delivery Amount For Captain" type="number" class="form-control" id="delivery_amount_main" contenteditable="true"><?php echo $result['delivery_charges']; ?></span>
                                        <select class="form-select delivery_captain_dropdown">
                                            ...
                                            if($db->sql($del_sql))
                                            {
                                                ...
                                                if($del_num > 0)
                                                {
                                                    ...
                                                    {
                                                    ?>
                                                    <option value="<?php echo base64_encode($captain['id']); ?>"><?php echo  $captain['name']; ?></option>
                                                    <?php
                                                    }
                                                }
                                            }
                                        ...
                                        <button data-customer="<?php echo base64_encode($result['customer_id']); ?>" data-id="<?php echo base64_encode($result['id']); ?>" class="btn btn-info submit_btn px-4" type="button" id="assign_captain_main_btn">Assign</button>
                                    </div>
                                </div>
                                <?php
                                }
